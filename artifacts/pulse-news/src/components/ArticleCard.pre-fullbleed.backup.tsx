      ...
      {!isDesktop && (
        <>
          ...
          >
            ...
            {/* Compositional tint, single layered background:
                  1. Faint cream glow from upper-left (mostly off-canvas — a
                     hint of warmth, not a blotch on warm-toned images).
                  2. Vertical dom-color depth: lighter near the image edge,
                     richer toward the bottom-nav. */}
            <div
